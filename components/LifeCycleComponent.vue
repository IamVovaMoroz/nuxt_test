...
// Lifecycle Hooks
// onBeforeMount
onBeforeMount(()=> {console.log(' onBeforeMount - Component is about to be mounted')})
// onMounted
onMounted(()=>{
...
const updateMessage = ()=>{
	message.value = 'the message was updated function'
...
<p>{{ message }}</p>
<button @click="updateMessage" class="border bg-slate-500">Update message</button>
